			...
			<img src={gift.image} alt={gift.name} className="product-image-large" />
                    ...
                    // Task 6: Display gift details
                        ...
                        {gift.category ? (gift.category
                            ...
                            <div className="no-category-available">No Category Available</div>
                        )}
			</p>
                    	<p><strong>Condition:</strong> 
                        {gift.conditon ? (gift.conditon
                        ) : (
                            <div className="no-condition-available">No Condition Available</div>
                        )}
                    	</p>
                    	<p><strong>Date Added:</strong> 
                        {gift.dateAdded ? (gift.dateAdded
                        ) : (
                            <div className="no-added-date-available">No Added Date Available</div>
                        )}
                        </p>
                    	<p><strong>Age (Years):</strong> 
                        {gift.age ? (gift.age
                        ) : (
                            <div className="no-age-available">No Age Available</div>
                        )}
                    	</p>
                    	<p><strong>Description:</strong> 
                        {gift.description ? (gift.description
                        ) : (
                            <div className="no-description-available">No Description Available</div>
                        )}
                    	</p>
                </div>
            </div>
